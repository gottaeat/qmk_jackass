...
static bool firstDisconnect = true;
...
static void lkbt51_param_init(void) {
    ...
    module_param_t param = {.event_mode             = 0x02,
                            ...
                            .report_rate            = 90,
                            .vendor_id_source       = 1,
                            .verndor_id             = VENDOR_ID, // Must be 0x3434 or 0x362D
...
void wireless_pre_task(void) {
    ...
    if (time == 0) {
        uint8_t pins_state = (gpio_read_pin(BT_MODE_SELECT_PIN) << 1) | gpio_read_pin(P24G_MODE_SELECT_PIN);
